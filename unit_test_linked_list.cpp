...
int data_value_of_second_elt = 0;
...
TEST_CASE("linked_list testing")
{
    ...
    SUBCASE("build_new_linked_list")
    {
        ...
        CHECK_EQ(get_linked_list_data_item_value(linked_list_one_elt, 0,
                                                 one_element_linked_list),
                 data_value_of_initial_linked_list_elt);

        CHECK_EQ(get_linked_list_data_item_value(linked_list_two_elts, 1,
